...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	try {
		...
		$md5 = md5($password);
		$query = "SELECT * FROM users WHERE username = '$user' AND password = '$md5'";
...
<body class="h-full">
	<div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
		<div class="max-w-md w-full space-y-8">
			<div>
				<h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">User Administration Console</h2>
